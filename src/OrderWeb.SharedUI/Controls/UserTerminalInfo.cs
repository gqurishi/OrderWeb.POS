...
public class UserTerminalInfo : ContentView
{
    ...
    public UserTerminalInfo()
    {
        ...
        _user = new Label { Text = "No user", FontSize = 14, FontAttributes = FontAttributes.Bold }; _user.Use(Label.TextColorProperty, "OwTextStrong");
        _terminal = new Label { Text = "Terminal", FontSize = 12 }; _terminal.Use(Label.TextColorProperty, "OwTextMuted");
