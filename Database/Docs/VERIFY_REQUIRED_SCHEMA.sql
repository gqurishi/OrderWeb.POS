...
FROM (
    ...
    UNION ALL SELECT 'order_service_availability_settings', 'reservation_enabled'
    ...
    UNION ALL SELECT 'order_service_availability_events', 'previous_reservation_enabled'
    UNION ALL SELECT 'order_service_availability_events', 'new_reservation_enabled'
    UNION ALL SELECT 'terminal_events', 'event_type'
